...
The title of the research paper is Association between adding salt in food and dementia in European descent: A Mendelian randomization study. It's main authors and contributors were Ren Zhou and Hong Jiang. 
...
The data on the genetic variation of added salt to food was taken from the UK Biobank. The dataset identifier was “ukb-b-8-12”. You can access the UK Biobank through the link : https://www.ukbiobank.ac.uk/, but without an ID, you cant really go much further so I wasn't able to access this data : sad :
